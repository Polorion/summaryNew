  ...
  return (
    <div className={S.sectionExp}>
      ...
      <div className={S.info}>
        ...
        библиотеки React. Получил диплом после прохождения курса по верстке и
        закончил курс по JS,React. Умею: создавать SPA приложения, верстать
        сайты и лендинги по макетам, создавать страницы комфортные для просмотра
        и взаимодействия на любом экране и устройстве, в любом браузере, не
